...
public class HBKDownloadActivity extends Activity {
    ...
    private Button buttonDelete, buttonDeleteThumbs;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonDeleteThumbs = (Button) this.findViewById(R.id.buttonDeleteThumbs);
        ...
        relativeLayoutTitle = (RelativeLayout) this.findViewById(R.id.relativeLayoutTitle);
		...
		top_view_back.setTextColor(0xff000000);
		relativeLayoutTitle.setBackgroundColor(0xfffcabbd);
		...
		buttonDeleteThumbs.setOnClickListener(new OnClickListener() {
			@Override
			public void onClick(View v) {
				deleteThumbsFiles();
			}
	...
	private void deleteThumbsFiles() {
		File sdcardDir = Environment.getExternalStorageDirectory();
        String path = sdcardDir.getPath() + "/hbksugar_thumbs";
    	if (Environment.MEDIA_MOUNTED.equals(Environment.getExternalStorageState())){
            File filePath = new File(path);
            if (!filePath.exists()) {
        		Toast.makeText(this, 
